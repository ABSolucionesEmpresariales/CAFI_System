                  ...
                  <form class="form-group" id="formulario">
                    ...
                    <div class="d-block d-lg-flex row">
                      ...
                      <div class="col-lg-4">
                        ...
                        <input id="marca" class="form form-control" onkeypress="return check(event)" type="text" name="Tmarca" placeholder="Marca" autocomplete="new-password" >
                      </div>
                    </div>
                    <div class="d-block d-lg-flex row">
                      <div class="col-lg-4">
                        <h5 class="general">Color:</h5>
                        <input id="color" class="form form-control" type="text" onkeypress="return check(event)" name="Tcolor" placeholder="Color" autocomplete="new-password"><br>
                      </div>
                      <div class="col-lg-4">
                      ...
                      <div class="col-lg-4">
                        ...
                        <input id="precio_compra" class="form form-control" type="number" onkeypress="return check(event)" name="Nprecio_compra" placeholder="Precio de compra" autocomplete="new-password"><br>
                      </div>

                      <div class="col-lg-4">
                        <h5 class="general">Precio venta:</h5>
                        <input id="precio_venta" class="form form-control" type="number" onkeypress="return check(event)" name="Nprecio_venta" placeholder="Precio de venta" autocomplete="new-password" required><br>
                      </div>
                      <div class="col-lg-4">
