          ...
          <form class="form-group" enctype="multipart/form-data" id="formulario">
            ...
            <div class="d-block d-lg-flex row">
              <div class="col-lg-6 ocultarCodigo">
                ...
                <input id="codigo_barras" class="form form-control" onkeypress="return codigo(event)" type="text" name="Tcodigo_barras" placeholder="0000000000000" maxlength="13" required>
