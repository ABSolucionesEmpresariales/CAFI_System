...
if (isset($_POST['combo']) && $_POST['combo'] === "negocio") {
...
} else if (isset($_POST['Ssucursal']) && isset($_POST['Dfecha1']) && isset($_POST['Dfecha2']) || isset($_POST['Ssucural']) && isset($_POST['Dmes'])) {
    $conexion = new Models\Conexion();
    ...
    if ($_POST['negocio'] != "Todos") {
        ...
        if (!isset($_POST['Dmes'])) {
            ...
            $conexion->consultaPreparada($datos,$consulta,2,"sssiss", false);
            $datos = array($mes, $año, "A", 1, $_POST['Ssucursal'], NULL, NULL, NULL, NULL, NULL);
            
        }

        $datos = array($_POST['Dfecha1'], $_POST['Dfecha2'], $_POST['Ssucursal']);
        ...
        $result = $conexion->consultaPreparada($datos, $consulta, 2, "sssissssss", false);
        if (isset($result) && !is_null($result[0][0])) {
            $ventas = $result[0][0];
        } else {
            $ventas = 0;
